...
**UPD: Теперь все настройки включены в [VK Schemes](https://github.com/evtn/vk-schemes), а этот репозиторий будет архивирован и не будет получать обновлений. Тёмная (как и другие схемы) - там же**
...
2. Выбрать стиль
    - Если вам нужны tweaks, перейти по [ссылке](https://raw.githubusercontent.com/evtn/vk-tweaks/lord/vk.user.css)
    - Если вам нужна темная тема, перейти по [ссылке](https://raw.githubusercontent.com/evtn/vk-tweaks/lord/dark.user.css)
